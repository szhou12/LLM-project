...
def concat_question(q, a):
    sentence = f'Question: {q}. Answer'


## TODO
def predict(model_name):
    with open('result_pretrained.json', 'r') as f:
        data = json.load(f)
    ...
    # result = []
    # for topic, questions in answers.items():
...
if __name__ == "__main__":
    ...
    with open('result/results_pretrained_comment.json', 'w') as f:
